...
export const Bot = (props: BotProps & { class?: string }) => {
  ...
  const predefinedQuestions = props.chatflowConfig?.predefinedQuestions || [
    "What is Cloozo?",
    "How does Cloozo work?",
    "What are the benefits of using Cloozo?",
    "Who should use this?"
  ];
  ...
  return (
    <>
      ...
      >
            ...
            <For each={[...messages()]}>
              {message => (
                <>
                  ...
                  {message.type === "userMessage" && loading() && (
                    <LoadingBubble />
                  )}
        ...
        />
        <BottomSpacer ref={ref => (bottomSpacer = ref)} />
      </div>
      {sourcePopupOpen() && (
